...
export const FEED_POSTS: FeedPost[] = [
  ...
  },
  {
    ...
    text: 'Strategic integration with the 1inch DEX aggregator goes live. All Umia pools are now accessible to 2M+ 1inch users.',
  ...
  },
  {
    ...
    detailText: 'Wallet 0x8f2a...4c19, a top-5 UMIA holder with 2.3M tokens (1.2% of supply), transferred its full balance to a Binance deposit address at block #8,441,829. The wallet was inactive for 11 months. No team communication issued. Could be OTC, staking migration, or a sell. Community has tagged the Umia X account requesting a statement.',
    time: '2d ago',
