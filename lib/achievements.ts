...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    id:         'genesis_tier',
    name:       'Genesis Tier',
    desc:       'Accumulate 600 ZXP total balance',
    icon:       'ph-trophy',
    iconColor:  '#c9a55a',
    badgeLabel: 'Genesis',
    check:      s => s.zxp_balance >= 600,
    progress:   s => ({ current: Math.min(Math.floor(s.zxp_balance), 600), total: 600 }),
  },
  {
    id:         'verdicts_100',
    name:       '100 Verdicts',
    desc:       'Submit 100 community verdicts',
    icon:       'ph-star',
    iconColor:  '#a855f7',
    badgeLabel: '100 Verdicts',
    check:      s => s.verdicts >= 100,
    progress:   s => ({ current: Math.min(s.verdicts, 100), total: 100 }),
  },
  {
    id:         'referrals_5',
    name:       'Recruiter',
